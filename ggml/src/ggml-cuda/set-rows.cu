...
static void set_rows_cuda(ggml_backend_cuda_context & ctx, const ggml_tensor * src0, const ggml_tensor * src1, ggml_tensor * dst) {
    ...
    if (dst->type == GGML_TYPE_F32) {
        ...
        set_rows_cuda_quant<idx_t, block_pq4_0, QK_PQ, quantize_f32_pq4_0_block>(
            src0_d, src1_d, (block_pq4_0*)dst->data,
            ne00, ne01, ne02, ne03,
            ne10, ne11, ne12, ne13,
            nb01, nb02, nb03,
            nb10, nb11, nb12,
        ...
        set_rows_cuda_quant<idx_t, block_pq3_0, QK_PQ, quantize_f32_pq3_0_block>(
            src0_d, src1_d, (block_pq3_0*)dst->data,
            ne00, ne01, ne02, ne03,
            ne10, ne11, ne12, ne13,
            nb01, nb02, nb03,
            nb10, nb11, nb12,
