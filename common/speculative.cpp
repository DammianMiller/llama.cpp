    ...
    std::vector<common_speculative_config> configs = {}; // list of speculative configs to try
    {
        ...
        if (has_ngram_mod) {
            ...
            if (!params.ngram_mod) {
                ...
                // Optional preload from a pre-trained NGMD v2 K=4 file (read-only).
                ...
                // Attempt to load persisted state from --spec-ngram-persist (cherry-picked from turbo b0e905ac1).
                // A preload + persist combo keeps the pretrained bootstrap and
                // then writes updates back on shutdown to this same file.
